    ...
    <!-- Main Sidebar Container -->
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">UFLS Admin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    ...
                    <!-- Add icons to the links using the .nav-icon class
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin_calendar') }}" class="{{ Request::segment(1) === 'admin_calendar' ? 'nav-link active' : 'nav-link' }}">
                        ...
                        <li class="{{ Request::segment(1) === 'admin_room_reports' ? 'nav-item active has-treeview menu-open' : 'nav-item has-treeview'}}">
                        ...
                        <li class="{{ Request::segment(1) === 'admin_rooms' 
                                    ...
                                    || Request::segment(1) === 'admin_halls' ? 'nav-item active has-treeview menu-open' : 'nav-item has-treeview'}}">
